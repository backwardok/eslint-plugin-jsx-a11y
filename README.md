...
------------ | ------------- | -------------
[accessible-emoji](docs/rules/accessible-emoji.md) | error | error
[alt-text](docs/rules/alt-text.md) | error | error
[anchor-has-content](docs/rules/anchor-has-content.md) | error | error
[anchor-is-valid](docs/rules/anchor-is-valid.md) | error | error
[aria-activedescendant-has-tabindex](docs/rules/aria-activedescendant-has-tabindex.md) | error | error
[aria-props](docs/rules/aria-props.md) | error | error
[aria-proptypes](docs/rules/aria-proptypes.md) | error | error
[aria-role](docs/rules/aria-role.md) | error | error
[aria-unsupported-elements](docs/rules/aria-unsupported-elements.md) | error | error
[autocomplete-valid](docs/rules/autocomplete-valid.md) | error | error
[click-events-have-key-events](docs/rules/click-events-have-key-events.md) | error | error
[heading-has-content](docs/rules/heading-has-content.md) | error | error
[html-has-lang](docs/rules/html-has-lang.md) | error | error
[iframe-has-title](docs/rules/iframe-has-title.md) | error | error
[img-redundant-alt](docs/rules/img-redundant-alt.md) | error | error
[interactive-supports-focus](docs/rules/interactive-supports-focus.md) | error | error
[label-has-associated-control](docs/rules/label-has-associated-control.md) | error | error
[media-has-caption](docs/rules/media-has-caption.md) | error | error
[mouse-events-have-key-events](docs/rules/mouse-events-have-key-events.md) | error | error
[no-access-key](docs/rules/no-access-key.md) | error | error
[no-autofocus](docs/rules/no-autofocus.md) | error | error
[no-distracting-elements](docs/rules/no-distracting-elements.md) | error | error
[no-interactive-element-to-noninteractive-role](docs/rules/no-interactive-element-to-noninteractive-role.md) | error, with options | error
[no-noninteractive-element-interactions](docs/rules/no-noninteractive-element-interactions.md) | error, with options | error
[no-noninteractive-element-to-interactive-role](docs/rules/no-noninteractive-element-to-interactive-role.md) | error, with options | error
[no-noninteractive-tabindex](docs/rules/no-noninteractive-tabindex.md) | error, with options | error
[no-onchange](docs/rules/no-onchange.md) | error | error
[no-redundant-roles](docs/rules/no-redundant-roles.md) | error | error
[no-static-element-interactions](docs/rules/no-static-element-interactions.md) | error, with options | error
[role-has-required-aria-props](docs/rules/role-has-required-aria-props.md) | error | error
[role-supports-aria-props](docs/rules/role-supports-aria-props.md) | error | error
[scope](docs/rules/scope.md) | error, with options | error
[tabindex-no-positive](docs/rules/tabindex-no-positive.md) | error | error
